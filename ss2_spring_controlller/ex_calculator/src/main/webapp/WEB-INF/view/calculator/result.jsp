...
<center>
    <form action="/calculator/result" method="get">
        <h2>Calculator</h2>
        <div class="mb-3">
            <input type="number" name="firstOperand" class="form-control" placeholder="1st operand" value="${firstOperand}" style="width: 300px">
            <input type="number" name="secondOperand" class="form-control" placeholder="2st operand" value="${secondOperand}" style="width: 300px">
        </div>
        <div>
